...
class PlainTasksNewCommand(PlainTasksBase):
    def runCommand(self, edit):
        ...
        for i, line in enumerate(regions):
            ...
            holds_starter  = re.match('^(.*▪.*)$', self.view.substr(line))
            ...
            if 'item' in current_scope:
                ...
                if holds_starter:
                    line_contents = self.view.substr(line) + '\n' + grps[0] + self.open_tasks_third_bullet + self.tasks_bullet_space
                else:
                ...
                grps = not_empty_line.groups()
                line_contents = self.view.substr(line) + '\n' + grps[0] + self.tasks_bullet_space + self.tasks_bullet_space + self.open_tasks_bullet + self.tasks_bullet_space
                ...
                if not_empty_line:
                    ...
                    line_contents = grps[0] + self.open_tasks_secondary_bullet + self.tasks_bullet_space
                else:  # completely empty, no whitespaces
                    line_contents = self.tasks_bullet_space + self.tasks_bullet_space + self.open_tasks_bullet + self.tasks_bullet_space
            else:
